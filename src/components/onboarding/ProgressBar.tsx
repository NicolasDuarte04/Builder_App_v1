...
export function ProgressBar({ currentStep, totalSteps }: ProgressBarProps) {
  ...
  return (
    <div className="flex items-center space-x-3 relative w-36 md:w-48">
      <div className="w-full h-2 bg-gray-200/50 backdrop-blur-sm rounded-full overflow-hidden relative">
        <div
      ...
      <div className="text-sm text-gray-600 min-w-fit bg-white/80 backdrop-blur-sm px-2 py-1 rounded">
